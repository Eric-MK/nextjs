        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              className={styles.card__text}
            >
              <motion.h3 variants={textVariants}>EPR (Emergency Response Program)</motion.h3>
              <motion.p variants={textVariants}>
                This is the cleaning and sanitization of offices to curb the spread of COVID-19 and other diseases
              </motion.p>
            </motion.div>
            <div className={styles.card__img}>
              <img src="/images/cleaning.jpg" alt="cleaning" />
